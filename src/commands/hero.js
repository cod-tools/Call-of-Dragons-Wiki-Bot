...
module.exports = {
    commandData: new SlashCommandBuilder()
        ...
        .setDescription("Get information about a Call of Dragons hero")
        .addStringOption(new SlashCommandStringOption()
            .setChoices(
                ...Object.keys(hero).map(key => ({ name: key, value: key }))
            )
            .setRequired(true)
            .setName("selection")
    ...
    run: async(client, interaction) => {
        ...
        if(hero[userSelection]["image"] != null) {
            const file = new Discord.MessageAttachment().setFile(`./assets/${categoryName}/${hero[userSelection]["image"]}`).setName("image.png");
            ...
            embed2.setDescription(`**Rarity:**\n${hero[userSelection]["rarity"]}\n\n**Role:**\n${hero[userSelection]["role"]}\n\n**Buffs:**\n${hero[userSelection]["buffs"]}\n\n**Units:**\n${hero[userSelection]["units"]}\n\n**Tier:**\n${hero[userSelection]["tier"]}\n\n**Best Pairings:**\n${hero[userSelection]["pairings"]}`);
